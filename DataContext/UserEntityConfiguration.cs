		...
		public UserEntityConfiguration()
		{
			...
			this.Property(u => u.FirstName)
				...
				.HasColumnAnnotation(
						...
						new IndexAnnotation(new IndexAttribute("IX_FirstNameLastName", 1))
				)
				.IsRequired();
			...
			this.Property(u => u.LastName)
				...
				.HasColumnAnnotation(
						IndexAnnotation.AnnotationName,
						new IndexAnnotation(new IndexAttribute("IX_FirstNameLastName", 2))
				)
				.IsRequired();
			...
			this.Property(u => u.Job)
				...
				.HasColumnAnnotation(
						IndexAnnotation.AnnotationName,
						new IndexAnnotation(new IndexAttribute("IX_Job"))
				)
				.IsOptional();
